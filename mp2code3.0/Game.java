...
class Game{
	...
	public Point minmax(){
		...
		if ((astep.size()+estep.size())>(ssize*(ssize-1))){
			processvarious();
			return findmaxinhash(tt);
		}
...
//System.out.println("123");
	...
	public void processinitial(int who,int ccase, Point a, Point b){
		if (ccase<=3){
			if (((!notexist(b))||(!notout(b)))||((!notexist(a))||(!notout(a)))){
				ccase=ccase-1;
			}
		}
		processhelper(who,ccase,a);					
		processhelper(who,ccase,b);
